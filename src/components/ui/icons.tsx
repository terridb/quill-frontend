...
export function BookPagesIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
      ...
      aria-hidden="true"
    >
      <path d="M6 4h8a2 2 0 0 1 2 2v14a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2V6a2 2 0 0 1 2-2z" />
      <path d="M10 4v14" />
      <path d="M14 6h4a2 2 0 0 1 2 2v12" />
    </svg>
  );
}
...
export function FlameIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.5-.5-2-1-3-1.5-2.5-.5-4.5.5-6 1 2 2 4 2 6 0 2-1.5 3-2.5 5.5z" />
      <path d="M12 22c4-2 5-6 5-9 0-3-2-5-5-7-3 2-5 4-5 7 0 3 1 7 5 9z" />
    </svg>
  );
}
